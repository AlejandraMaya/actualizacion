...
const ReporteDiabetes = (props) => {
    ...
    const onsubmit = async props =>{
        ...
        await axios.post(`http://localhost:3008/api/email/aprendiz`,{ //cambiar despues la ruta
            cedula: cedula
        })
    }
                        ...
                        <Modal.Body>
                            <Container>
                                ...
                                <Form onsubmit={onsubmit}>
                                    ...
                                    {/* <div className="App">
                                        <button type="button" class="btn btn-success" onClick={prueba}>Registrar</button>
                                    </div> */}
                                </Form>
                            </Container>
                        </Modal.Body>
